...
def mayorRecaudoCabina(cab1_queue,cab2_queue,cab3_queue):
    ...
    for i in range(cab1_queue.size()):
        cabina1=cab1_queue.on_front()
        recaudoCabina1=recaudoCabina1+cabina1.tarifa
        cab1_queue.move_to_end()
    
    for i in range(cab2_queue.size()):
        cabina2=cab2_queue.on_front()
        recaudoCabina2=recaudoCabina2+cabina2.tarifa
        cab2_queue.move_to_end()
        
    for i in range (cab3_queue.size()):
        cabina3=cab3_queue.on_front()
        recaudoCabina3=recaudoCabina3+cabina3.tarifa
        cab3_queue.move_to_end()
